...
<div class="card-header">
    <span class='admin-title mr-3'>Izmeni Akciju</span>            
</div>
<div class="card-body">   
    ...
    <form method="POST" action="{{route('actions.update', $action->id)}}" enctype="multipart/form-data">
        ...
        <div class="form-group row">
            ...
            <div class="col-md-6">
                <input id="name" type="text" class="form-control @error('name') is-invalid @enderror" name="name" value="{{ old('name') ?? $action->name }}"  autocomplete="name" autofocus>
        ...
        <div class="form-group row">
            ...
            <div class="col-md-6">
                <input id="slug" type="text" class="form-control @error('slug') is-invalid @enderror" name="slug" value="{{ old('slug') ?? $action->slug }}"  autocomplete="slug" autofocus>
        ...
        <div class="form-group row">
            ...
            <div class="col-md-6">
                <input id="discount" type="number" min="0" max="100" class="form-control @error('discount') is-invalid @enderror" name="discount" value="{{ old('discount') ?? $action->discount }}"  autocomplete="discount" autofocus>
        ...
        <div class="form-group row">
            ...
            <div class="col-md-6">                                  
                <select name="active" class="form-control">
                    <option {{ $action->active == 1 ? 'selected' : ''}} value="1">aktuelna</option>
                    <option {{ $action->active == 0 ? 'selected' : ''}} value="0">istekla</option>
                </select>           
            </div>
        </div>
